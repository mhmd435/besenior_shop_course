        ...
        children: [
          ...
          SizedBox(
            ...
            child: TypeAheadField(
                ...
                textFieldConfiguration: TextFieldConfiguration(
                  onTap: () {
                    // BlocProvider.of<HomeBloc>(context).add(ChangeHintVisibility(false));
          ...
          IgnorePointer(
            child: Padding(
              ...
              child: Row(
                children: [
                  Text('جستوجو در', style: TextStyle(fontSize: 17,fontFamily: "Yekan",color: Colors.grey, fontWeight: FontWeight.w200),),
                  ColorFiltered(
